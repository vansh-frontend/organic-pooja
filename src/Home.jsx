  ...
  return (
    ...
    >
      <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[32rem]">
        <img src="img/pro1.jpg" alt="Slide 1" className="object-cover w-full h-full" />
      ...
      <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[32rem]">
        <img src="img/pro2.jpg" alt="Slide 2" className="object-cover w-full h-full" />
        <p className="absolute px-4 py-2 text-xs text-white bg-black bg-opacity-50 rounded-lg bottom-4 left-4 sm:text-sm md:text-base lg:text-lg">
          Legend 2
        </p>
      </div>
      <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[32rem]">
        <img src="img/pro3.jpg" alt="Slide 3" className="object-cover w-full h-full" />
        <p className="absolute px-4 py-2 text-xs text-white bg-black bg-opacity-50 rounded-lg bottom-4 left-4 sm:text-sm md:text-base lg:text-lg">
          Legend 3
        </p>
      </div>
