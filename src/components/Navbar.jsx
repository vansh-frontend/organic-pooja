    ...
    <>
      <ul className="hidden space-x-8 lg:flex">
        <li>
          <NavLink
            to="/"
            className="relative p-3 text-lg font-medium text-black transition-all duration-500 group hover:opacity-75 hover:text-yellow-500"
          >
            Home
...
<li><NavLink to="/laser-hair-treatment" className="block text-sm text-gray-700 hover:text-black">IV Drips For Skin</NavLink></li>
  ...
  <li>
    <NavLink
      to="/Cart"
      className="relative flex items-center p-3 text-lg font-medium text-black transition-all duration-500 group hover:opacity-75 hover:text-yellow-500"
    >
  ...
  <li>
    <NavLink
      to="/book"
      className="relative flex items-center p-3 text-lg font-medium text-white transition-all duration-500 bg-black hover:opacity-75 group hover:text-yellow-500"
    >
      Book Appointment
